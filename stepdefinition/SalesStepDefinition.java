...
public class SalesStepDefinition {
	...
	@When("Enter in the accountname as kousthu")
	public void enter_in_the_account_name_as_kousthu() throws InterruptedException {
		driver.findElement(By.xpath("//label[text()='Account Name']/following::input")).sendKeys("kousthu");
		Thread.sleep(5000);
	}
